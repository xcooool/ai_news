...
window.fetch = async (input, options = {}) => {
  ...
  return new Response(JSON.stringify({
    items:scoreItems(items,{selectedSourceIds,weights}), sources:sourceCatalog,
...
const disableWrites = () => document.querySelectorAll("#refreshBtn,#saveWeightsBtn,#importForm button,[data-status-action]").forEach(button => {
