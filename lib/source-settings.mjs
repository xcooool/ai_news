...
export function summarizeSourceTargets(sourceId, config) {
  ...
  if (sourceId === "yc") return "yc-oss AI 公司目录（全量近四年 Active）";
  ...
  if (sourceId === "producthunt") return process.env.PRODUCTHUNT_TOKEN ? "Product Hunt 最新发布" : "需 PRODUCTHUNT_TOKEN";
  if (sourceId === "reddit") return "内置 subreddit RSS";
  if (sourceId === "x") return "内置作者 timeline（公开嵌入，无需 key）";
