...
/** 即刻 / 知乎 / 小红书：只保留项目锚点或创业/开源信号，泛 AI 热榜新闻不进库 */
const STRICT_SOCIAL_SOURCES = new Set(["jike", "zhihu", "xiaohongshu"]);
...
export function applyIntentClassification(item, keywords = DEFAULT_INTENT_KEYWORDS) {
  ...
  if (STRICT_SOCIAL_SOURCES.has(sourceId) && type === "hotnews" && !anchored) {
    return null;
  }
