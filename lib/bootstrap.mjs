...
export function templateConnectors() {
  return validateLike({
    ...
    weweBaseUrl: "",
    rsshubBaseUrl: "",
    keywords: ["ai github", "ai startup", "ai startup hiring", "ai hot github", "AI", "agent", "llm", "开源"],
    xhsKeywords: ["ai github", "ai startup", "ai startup hiring", "ai hot github"],
    zhihuKeywords: ["AI", "agent", "llm", "开源", "智能体", "大模型"],
    wechatFeedIds: ["all"],
    routes: {
      zhihu: [],
      jike: [],
...
function validateLike(input) {
  ...
  return {
    ...defaults,
    ...input,
    keywords: [...(input.keywords ?? defaults.keywords)],
    xhsKeywords: [...(input.xhsKeywords ?? defaults.xhsKeywords)],
    zhihuKeywords: [...(input.zhihuKeywords ?? defaults.zhihuKeywords)],
    wechatFeedIds: [...(input.wechatFeedIds ?? defaults.wechatFeedIds)],
    routes: { ...defaults.routes, ...input.routes },
    sourceSettings: { ...(defaults.sourceSettings ?? {}), ...(input.sourceSettings ?? {}) },
  };
}
...
export function mergeConnectors(existing, template) {
  const merged = validateLike({
    ...
    zhihuKeywords: existing.zhihuKeywords?.length ? existing.zhihuKeywords : template.zhihuKeywords,
